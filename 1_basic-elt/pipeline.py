...
print("Starting ELT pipeline script...")

# Configurations for the source PostgreSQL database
source_config = {
    'dbname': 'source_db',
    'user': 'postgres',
    'password': 'secret',
...
dump_command = [
    ...
    '-f', 'data_dump.sql',  # -f is for the file
    '-w'  # Do not prompt for the password
]
...
load_command = [
    ...
    '-a', '-f', 'data_dump.sql'  # -a is for echo all commands from the input script
]
